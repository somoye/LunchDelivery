    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $.each(response.data, function () {
                $('<li class="list-product list-product-active"/>').html('<div class="list-product-title"/>' + '<div class="list-product-desc"/>' + '<div class="list-product-price"/>' + '<div class="clear" />' + '<span class="order-product">заказать</span>').appendTo(list)
            });
